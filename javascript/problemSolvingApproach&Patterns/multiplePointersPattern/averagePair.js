...
determins if there is a pair of values in the array where the average of the pair equals the target average.
...
const averagePair = (arr, average) => {
  ...
  while (pointerOne < pointerTwo) {
    const tempAverage = (arr[pointerOne] + arr[pointerTwo]) / 2;
